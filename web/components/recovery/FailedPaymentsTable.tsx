              ...
              >
                ...
                <TableCell className="text-right whitespace-nowrap">
                  <div className="flex items-center justify-end gap-2" onClick={(e) => e.stopPropagation()}>
                    <Button variant="ghost" size="icon" aria-label="Send communication" className="h-8 w-8 text-slate-400 hover:text-blue-400">
                      <MaterialIcon name="send" className="text-lg" />
                    </Button>
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="ghost" size="icon" aria-label="More options" className="h-8 w-8 text-slate-400 hover:text-slate-100">
